            ...
            <div className="mt-auto">
              {isInCart ? (
                ...
                <button
                  ...
                  disabled={localCartLoading || !user}
                  className="w-full cursor-pointer bg-[#5D5FEF] hover:bg-[#4B4DC9] text-white border border-transparent py-1.5 rounded-md font-semibold text-[10px] sm:text-xs transition-all duration-300 flex items-center justify-center gap-1.5 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <ShoppingBag size={14} />
