          ...
          <Link href={`/product/${product.id}`}>
            <div className="relative aspect-[3/4] overflow-hidden bg-gray-100 flex-shrink-0">
              ...
              <button
                ...
                className={`absolute top-2 right-2 w-8 h-8 cursor-pointer bg-white/90 backdrop-blur-sm rounded-full flex items-center justify-center transition-all duration-300 z-20 hover:scale-110 ${
                  isWishlisted
            ...
            <div className="mt-auto">
              {isInCart ? (
                <button
                  ...
                  className="w-full cursor-pointer bg-indigo-50 hover:bg-indigo-100 text-indigo-700 border border-indigo-100 py-1.5 rounded-md font-semibold text-[10px] sm:text-xs transition-all duration-300 flex items-center justify-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  <>
                    <Trash2 size={14} />
