                    ...
                    <div className="flex items-center justify-between">
                      ...
                      {isInCart ? (
                        <button
                          ...
                          className="px-3 cursor-pointer py-1.5 bg-indigo-50 text-indigo-700 border border-indigo-100 rounded-lg hover:bg-indigo-100 transition-all duration-300 text-xs font-semibold flex items-center gap-1 disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          <Trash2 size={14} />
                          <span>Remove</span>
                        </button>
                        ...
                        <button
                          onClick={(e) => handleAddToCart(product, e)}
                          disabled={isCartLoading || cartLoading}
                          className="px-3 cursor-pointer py-1.5 bg-[#5D5FEF] text-white rounded-lg hover:bg-[#4B4DC9] transition-colors text-xs font-medium flex items-center gap-1 disabled:opacity-50"
                        >
                          <>
                            <ShoppingBag size={14} />
                            <span>Add</span>
